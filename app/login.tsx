/**
 * Login screen (placeholder). Layout + localized copy only — NO authentication
 * yet. Real email/password/OTP/OAuth flows are built in Phase 2.
 */
  ...
  return (
    <Screen>
      ...
      <View style={styles.form}>
        ...
        <Button label={t('auth.loginCta')} disabled />
      </View>
